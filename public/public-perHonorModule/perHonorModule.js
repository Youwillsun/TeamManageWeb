 ...
 * @Date:2018-11-24
 */
function perHonorInformation(id, num) {
    perHonor.perHonorIntroduce(id, num);
}

var perHonor = (function() {
    function perHonorIntroduce(id, num) {
        for (var i = 1; i <= num; i++) {
            var tag = "<section index='" + i + "' id='honorIntroduce' class='wow slideInRight'> ";
                ...
                tag += "<p class='honorIntroduceWord'>" + "荣耀感悟" + "</p>";
                ...
                tag += "<p class='honorLeadingWord'>" + "荣耀建议" + "</p>";
                ...
                tag += "</div>";
                tag +="<div class='detailedBtn' data-toggle='modal' data-target='#myModalMate'>感悟或建议</div>"
                tag += "</div>";
                tag += "</div>";
                tag += "</div>";
                tag += "</div>";
    ...
    return {
        perHonorIntroduce: perHonorIntroduce
    }
